/*! For license information please see main.js.LICENSE.txt */ ! function(e) {
    ...
    function h(e, t) {
        ...
        const i = document.querySelector("#sib-form-container"),
        ...
        s ? (s.style.display = "none", l.style.display = "inline-block") : (l.querySelector("svg").addClass("sib-hide-loader-icon"), l.removeAttribute("disabled"), l.classList.remove("sib-form-block__button-disabled")), a.classList.remove("sib-form-message-panel--active"), o.classList.remove("sib-form-message-panel--active");
        ...
        if (e.success) {
            ...
            if (e.redirect) window.top.location.replace(e.redirect);
                ...
                if (a.classList.add("sib-form-message-panel--active"), e.message) {
                    (a.getElementsByClassName("sib-form-message-panel__inner-text") || a.getElementsByClassName("sib-form-message-panel__text"))[0].innerText = e.message
                }
            ...
            if (window.AUTOHIDE) {
                i.querySelector("#sib-container").style.display = "none"
            }
        } else {
            if (window.grecaptcha && window.grecaptcha.reset(), o.classList.add("sib-form-message-panel--active"), e.message) {
                (o.getElementsByClassName("sib-form-message-panel__inner-text") || o.getElementsByClassName("sib-form-message-panel__text"))[0].innerText = e.message
            }
            f(e.errors)
        }
    }
    ...
    function g() {
        ...
        n ? (n.style.display = "none", r.style.display = "inline-block") : (r.querySelector("svg").addClass("sib-hide-loader-icon"), r.removeAttribute("disabled"), r.classList.remove("sib-form-block__button-disabled")), t.classList.remove("sib-form-message-panel--active"), i.classList.add("sib-form-message-panel--active");
        ...
        console.log("just scrolled line 225")
    }

    function b(e) {
        const t = e.querySelector(".sib-loader") || e.querySelector(".loader"),
            i = e.querySelector('button[type="submit"]');
        t ? (t.style.display = "inline-block", i.style.display = "none") : (i.querySelector("svg").removeClass("sib-hide-loader-icon"), i.setAttribute("disabled", !0), i.classList.add("sib-form-block__button-disabled"));
    ...
    y.setAttribute("novalidate", "true"), y.addEventListener("submit", (e => {
        ...
        if ([...Array.from(y.getElementsByClassName("sib-optin")), ...Array.from(y.getElementsByClassName("sib-multiselect")), ...Array.from(y.getElementsByClassName("sib-checkbox-group")), ...Array.from(y.getElementsByClassName("sib-radiobutton-group"))].forEach((e => {
            ...
            e ? (e.style.display = "inline-block", t.style.display = "none") : (t.querySelector("svg").removeClass("sib-hide-loader-icon"), t.setAttribute("disabled", !0), t.classList.add("sib-form-block__button-disabled"));
        ...
        const e = document.querySelector("#sib-form-container"),
            ...
            i = e.querySelector('button[type="submit"]');
        t ? (t.style.display = "inline-block", i.style.display = "none") : (i.querySelector("svg").removeClass("sib-hide-loader-icon"), i.setAttribute("disabled", !0), i.classList.add("sib-form-block__button-disabled")), b(y)
